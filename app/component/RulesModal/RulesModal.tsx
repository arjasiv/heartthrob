    ...
    <>
      ...
      <FocusTrap>
        <div className={styles.modal}>
          ...
          lovers. Customize your own game with different personalities and
          traits, or quick-play a randomized game. <br />
          <br /> Main Game:
          <br />
          Each round will reveal a new traits about your potential heartthrob.
          For each round the players selects their favorite hearthrob, while
          also guessing which heartthrob the other players will chose. Each
          player gets one point for each co-player's choice they guess
          correctly.
          <br />
          <br />
